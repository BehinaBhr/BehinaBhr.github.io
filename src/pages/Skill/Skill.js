    ...
    <div className="skill">
      ...
      <div className="skill__section">
        ...
        <div className="skill__section-content">
          ...
          />
          <p>
          <span className="skill__section-content--bold">Learning new things gives my life meaning</span>, whether through <span className="skill__section-content--bold">feedback from others or self-studying</span>. Feel free
            to reach out to me; I'd love to hear from you and grow alongside you.
          </p>
          <img
