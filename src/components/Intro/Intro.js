  ...
  return (
    <div className="intro">
      <div className="intro__story">
          <div className="intro__story-title">🙋🏻‍♀️ My Story</div>
          <p className="intro__story-content">
            ...
            understand user needs and translate them into successful technical solutions. From deploying rescue robots
            to contributing to mental health research, and even developing the Procket, a productivity planning app for
            ...
            ways. Fueled by my drive for using technology to make a positive impact, I embarked on a self-directed
            journey into software development. Through a combination of online resources, immersive individual projects,
            ...
            hands-on learning experience equipped me to write clean, efficient code and deliver functional projects
            within tight deadlines, making me a valuable asset to any software development team.
          </p>
      <div/>
      ...
      <div className="intro__char">
        ...
        <div className="intro__open">
          <div className="intro__story-title">🤝🏼 Open to work</div>
          <p className="intro__story-content">
            A well-rounded background, driven by a passion for continuous learning and a drive to tackle new challenges,
            positions me as a highly motivated developer eager to contribute to user-centered software solutions. I'm
            open to opportunities in <span className="intro__story-content--bold">British Columbia, Canada </span> or{" "}
            <span className="intro__story-content--bold">Remotely </span>. I'm eager to discuss how my qualifications
