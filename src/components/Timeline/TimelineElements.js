let timelineElements = [
  ...
  },
  {
    ...
    description:
      "Led end-to-end recruitment processes, optimizing personnel actions and fostering a positive work environment by leveraging I-O Psychology. Managed HR operations, streamlining administrative tasks, maintaining office organization, and drafting documents using Microsoft Office. Achieved increased sales and brand awareness through enhanced social media communication with clients.",
  ...
  },
  {
    ...
    location: "Farzanegan 1 Highschool",
    description:
